        ...
        <div class="container" style="min-height: 600px;">
            ...
            <form runat="server">
                ...
                <asp:UpdatePanel ID="updIngreso" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="rechnungsdaten">
                            ...
                            <div class="form__group ort" id="divSucursal">
                        ...
                        <div>
                            ...
                            <div class="form__group">
                                ...
                                <input type="text" id="txtPeso" maxlength="7" runat="server" onkeypress="return ValidarNumero(event)" />
                            </div>
                ...
                <asp:UpdatePanel ID="updpnlBusqueda" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        <asp:Button Text="Registrar paquete" OnClick="btnRegistrar_Click" OnClientClick="return validacionGuardar();" ID="btnRegistrar" runat="server" />
